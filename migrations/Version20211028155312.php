...
final class Version20211028155312 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE absence (id INT AUTO_INCREMENT NOT NULL, inscription_id INT DEFAULT NULL, session_id INT DEFAULT NULL, INDEX IDX_765AE0C95DAC5993 (inscription_id), INDEX IDX_765AE0C9E3797A94 (session_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE session (id INT AUTO_INCREMENT NOT NULL, cours_id INT DEFAULT NULL, date_at DATETIME NOT NULL, heure_debut VARCHAR(5) NOT NULL, heure_fin VARCHAR(5) NOT NULL, is_statut TINYINT(1) NOT NULL, INDEX IDX_DF7DFD0E7ECF78B0 (cours_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE absence ADD CONSTRAINT FK_765AE0C9E3797A94 FOREIGN KEY (session_id) REFERENCES session (id)');
        ...
        $this->addSql('ALTER TABLE session ADD CONSTRAINT FK_DF7DFD0E7ECF78B0 FOREIGN KEY (cours_id) REFERENCES cours (id)');
